...
<!---------Side Navigation ---------->
    ...
    <div class="container">
    <h1 class="text-black">Vacancy Management <button class="btn btn-info pl-5" data-bs-toggle="modal" data-bs-target="#addVacancyModal">Add Vacancy</button></h1>
    
    <div class="card-body">
    <!-- Vacancy Table -->
    <table id="myTable" class="table table-striped table-bordered table-responsive  table-hover mt-3 $zindex-1" >
