 ...
 <!--Navigation Bar -->
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="viewcareer.html" class="active">Career</a>
    ...
    <section class="home" style="background: url(img/studio.jpg) 40% 60% fixed no-repeat ; height: 75%;">
...
<script type="text/javascript">
    (function (d, s, id) {
      ...
      js.onload = function () {
          var w = window.ConferbotWidget("655ee0edb3d7f38922ad0eb4", "live_chat");
      };
