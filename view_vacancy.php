...
if (isset($_GET['id'])) {
    ...
    if ($result && $row = mysqli_fetch_assoc($result)) {
        ...
        if ($row['vacancyStatus'] == 1) {
            ...
            echo '<p class="card-text" style="font-size: 25px;"><strong>Description:</strong> ' . $row['vacancyDesc'] . '</p>';
            echo '<a href="career.php"><button type="button" class="btn btn-info mr-2">
                    Back
                </button></a>';
            ...
            echo '<a href="career.php"><button type="button" class="btn btn-info">
                    Back
                </button></a>';
        }
    } else {
...
<div class="modal fade" id="applyModal" tabindex="-1" role="dialog" aria-labelledby="applyModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div  data-sitekey="6Le-BhEpAAAAAE6rn3Ojvt8gAH2NPyRc0ivZ7VVt">

            

                <form id="applicationForm" method="post" action="code.php" enctype="multipart/form-data" >
                    ...
                    <div class="g-recaptcha" data-sitekey="6Le-BhEpAAAAAE6rn3Ojvt8gAH2NPyRc0ivZ7VVt"></div>
                    ...
                    <button type="submit" class="btn btn-primary g-recaptcha" onclick="submitFormWithRecaptcha()">Submit Application</button>
                </form>
            </div>
...
var onloadCallback = function() {
    recaptchaWidget = grecaptcha.render('g-recaptcha', {
        'sitekey': '6Le-BhEpAAAAAE6rn3Ojvt8gAH2NPyRc0ivZ7VVt'
    });
};
