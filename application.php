...
<link href="https://cdn.datatables.net/v/bs4/jq-3.7.0/dt-1.13.7/datatables.min.css" rel="stylesheet">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
...
<script src="https://cdn.datatables.net/v/bs4/jq-3.7.0/dt-1.13.7/datatables.min.js"></script>
...
<body style="background: url(img/wallpapers2.jpg) 90% fixed no-repeat;">
...
<!---------Side Navigation ---------->
    ...
    <!--Application content --->
    <div class="container">
    <h1 class="text-black">Application Management <button class="btn btn-info pl-5" data-bs-toggle="modal" data-bs-target="#addApplicationModal">Add Application</button></h1>
    
    <div class="card-body">
    <!-- Vacancy Table -->
    <table id="myTable" class="table table-striped table-bordered table-responsive  table-hover mt-3" style="z-index:-2;">
        <thead>
            <tr>
...
<script>
    // Code using other JavaScript libraries that might also use $
$.noConflict();

// Use jQuery's noConflict mode and assign the jQuery object to a different variable, like jQuery
var j = jQuery.noConflict();

// Use jQuery using the 'j' variable
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (res.status == 422) {
                ...
                j('#viewApplicationModal').modal('show');
            }
        },
        error: function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (res.status == 422) {
                ...
                j('#editApplicationModal').modal('show');
            }
        },
        error: function() {
            console.log("Error occurred during the AJAX request.");
