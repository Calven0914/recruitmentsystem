...
document.addEventListener('DOMContentLoaded', function () {
            ...
            var passwordInfo = document.getElementById('pswd_info');
            ...
            function validatePassword(password) {
                ...
                document.getElementById('letter').classList.toggle('invalid', !lowercaseRegex.test(password));
                document.getElementById('capital').classList.toggle('invalid', !uppercaseRegex.test(password));
                document.getElementById('number').classList.toggle('invalid', !numberRegex.test(password));
                document.getElementById('length').classList.toggle('invalid', !lengthRegex.test(password));

                // Show the password info when the user starts typing
